...
export default function CustomerSegmentationChart({
  ...
  // Take top 5 segments if present, or format from raw customer data
  // For now, let's assume data is provided as { name: bucket_label, count: number }
  return (
